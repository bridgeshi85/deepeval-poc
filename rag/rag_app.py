...
# 配置参数
# ==========================================
# 获取当前文件的绝对路径，拼出确切的 chroma_db 位置
...
class MCPRagBot:
    def __init__(self):
        ...
        self.vectordb = Chroma(persist_directory=DB_PATH, embedding_function=embedding)
        ...
        # 3. 定义 Prompt
        template = """Answer the question based ONLY on the following retrieved context:
        {context}
        Please provide a concise and clear answer. If the answer is not present in the context, simply say "I don't know".
        Question: {question}
        """
...
if __name__ == "__main__":
    test_question = "Analyze the roles of host apps, MCP clients, servers, and transport layers in facilitating LLM-external system interactions?"
